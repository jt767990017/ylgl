(function (g) {
    ...
    var t = {
        ...
        dayReg: function (C) {
            ...
            var o = B.replace(/YYYY/, "([1-9]{1}[0-9]{3})").replace(A, "(" + C.splitStr + "?)").replace(/(MM|DD)/g,
                "([0-9]{1,2})");
            return new RegExp("^" + o + "$")
        },
        ...
        timeVal: function (B, o) {
            ...
            return o === "min" ? A.replace(/HH/, "00").replace(/mm/, "00").replace(/ss/, "00") : A.replace(/HH/, "23").replace(
                /mm/, "59").replace(/ss/, "59")
        },
        ...
        countSecond: function (o) {
            return o.length === 2 ? o = Number(o[0]) * 60 + Number(o[1]) : o.length === 3 ? o = Number(o[0]) * 3600 + Number(
                o[1]) * 60 + Number(o[2]) : false
        }
    };
    ...
    var k = {
        ...
        timeTpl: function (B, o) {
            var A =
                ...
                B + '" style="max-height: inherit; margin-bottom: -' + y + "px; margin-right: -" + y +
                'px;"><ul class="c-datepicker-scrollbar__view c-datepicker-time-spinner__list">' + o + "</ul></div></div>";
            return A
        },
        timeMainTpl: function (o, B) {
            var A =
                ...
                o.cancel + '</button><button type="button" class="c-datepicker-time-panel__btn confirm">' + o.confirm +
                "</button></div></div>";
            return A
        },
        sideBarButton: function (o, C, A) {
            var B = '<button type="button" class="c-datepicker-picker__shortcut "    data-value="' + o + '" data-time="' + C +
                '">' + A + "</button>";
            return B
        },
        ...
        pickerHeaderTpl: function (o, D, E, C, B, F) {
            var A = '<div class="' + D + '__header">' + E + '<span role="button" class="' + D + "__header-label " + D +
                '__header-year"><span>' + B + "</span> " + o.headerYearLink + '</span><span role="button" class="' + D +
                "__header-label " + D + '__header-month"><span>' + F + "</span> " + o.units[1] + "</span>" + C + "</div>";
            return A
        },
        pickerHeaderPrevTpl: function (o, B) {
            var A = '<i class="iconfont icon-zuozuo- c-datepicker-picker__icon-btn ' + B + '__prev-btn year" aria-label="' +
                o.prevYear + '"></i><i class="iconfont icon-zuozuo- c-datepicker-picker__icon-btn ' + B +
                '__prev-btn month" aria-label="' + o.nextMonth + '"></i>';
            return A
        },
        pickerHeaderNextTpl: function (o, B) {
            var A = '<i class="iconfont icon-youyou- c-datepicker-picker__icon-btn ' + B + '__next-btn month" aria-label="' +
                o.nextMonth + '"></i><i class="iconfont icon-youyou-  c-datepicker-picker__icon-btn ' + B +
                '__next-btn year" aria-label="' + o.nextYear + '"></i>';
            return A
        },
        // pickerHeaderNextSingleTpl: function(o, B) {
        // 	var A = '<i class="kxiconfont icon-last c-datepicker-picker__icon-btn ' + B + '__next-btn year" aria-label="' + o
        // 		.nextYear + '"></i><i class="kxiconfont icon-right c-datepicker-picker__icon-btn ' + B +
        // 		'__next-btn month" aria-label="' + o.nextMonth + '"></i>';
        // 	return A
        // },
        pickerTimeHeaderTpl: function (o, B) {
            var A = '<span class="' + B +
                ...
                o.chooseDay + '" class="c-datepicker-input__inner c-datePicker__input-day"></div></span><span class="' + B +
                '__editor-wrap"><div class="c-datepicker-input c-datepicker-input--small"><input type="text" autocomplete="off" placeholder="' +
                o.chooseTime + '" class="c-datepicker-input__inner c-datePicker__input-time"></div></span>';
            return A
        },
        ...
        rangePickerMainTpl: function (G, K, H, M, D, o, N) {
            ...
            var B = '<div class="c-datepicker-picker c-datepicker-date-range-picker c-datepicker-popper ' + K + " " + H +
                '" x-placement="top-start"><div class="c-datepicker-picker__body-wrapper">' + o +
                ...
                L + '<div class="c-datepicker-picker__content">' + N +
                '</div></div><div class="c-datepicker-date-range-picker-panel__wrap is-right">' + E +
                '<div class="c-datepicker-picker__content">' + N + "</div></div></div></div></div>" + J + I + "</div>";
            return B
        },
        ...
        rangePickerMainOnlyTimeTpl: function (B, A) {
            ...
            var C = '<div class="c-datepicker-picker c-datepicker-date-range-picker c-datepicker-popper ' + A +
        ...
        datePickerMainTpl: function (A) {
            ...
            var B =
                ...
                o + "</div>" + G + ' <div class="c-datepicker-picker__content">{{table}}</div></div></div>{{footerButton}}' + F +
                "</div>";
            return B
        },
        datePickerMainOnlyTimeTpl: function (o) {
            ...
            var A = '<div class="c-datepicker-picker c-datepicker-date-picker c-datepicker-popper ' + o +
    ...
    g.extend(v.prototype, {
        ...
        show: function () {
            this.picker.$container.find(
                ".c-datepicker-date-table,.c-datepicker-month-table,.c-datepicker-date-picker__header-month").hide();
            this.picker.$container.find(".c-datepicker-year-table").show()
        },
        hide: function () {
            this.picker.$container.find(".c-datepicker-year-table").hide();
            this.picker.$container.find(".c-datepicker-date-picker__prev-btn.year,.c-datepicker-date-picker__next-btn.year")
                .removeClass("is-year")
        },
        render: function (B) {
            ...
            this.picker.$container.find(
                ".c-datepicker-date-picker__prev-btn.month,.c-datepicker-date-picker__next-btn.month").hide();
            this.picker.$container.find(".c-datepicker-date-picker__prev-btn.year,.c-datepicker-date-picker__next-btn.year")
                .addClass("is-year")
        },
        renderHtml: function (G) {
            ...
            this.picker.$container.find(".c-datepicker-date-picker__header-year span").text(B + H.headerYearLink + "-" + (B +
                9));
            for (var E = 0; E < 10; E++) {
                var C = B + E;
    ...
    g.extend(e.prototype, {
        ...
        hide: function () {
            this.picker.$container.find(
                ".c-datepicker-date-picker__prev-btn.month,.c-datepicker-date-picker__next-btn.month").show();
    ...
    g.extend(b.prototype, {
        ...
        eventSingle: function () {
            ...
            function o(G, B) {
                ...
                if (!G.picker.hasTime) {
                    ...
                    t.judgeTimeRange(G.picker, G.picker.$container.find(".c-datePicker__input-day"), G.picker.$container.find(
                        ".c-datePicker__input-time"))
                }
            }
        ...
        eventRange: function () {
            ...
            function o(I, D) {
                ...
                if (I.current) {
                    ...
                    var H = I.current - 1;
                    t.judgeTimeRange(I.picker, I.picker.$container.find(".c-datePicker__input-day").eq(H), I.picker.$container.find(
                        ".c-datePicker__input-time").eq(H), H)
                }
            }
        ...
        renderHtml: function (K, ac, X) {
            ...
            var V = Q ? moment(t.newDateFixed(this.picker, this.picker.minJson.year + this.picker.splitStr + this.picker.minJson
                .month + this.picker.splitStr + 1)) : false;
            var o = S ? moment(t.newDateFixed(this.picker, this.picker.maxJson.year + this.picker.splitStr + this.picker.maxJson
                .month + this.picker.splitStr + 1)) : false;
            var W = "";
            var U = false;
        ...
        addRangeClass: function (G, Z, o) {
            ...
            var I;
            var ab = M.isBefore(t.newDateFixed(this.picker, B)) && M.isBefore(t.newDateFixed(this.picker, E)) && aa.isBefore(
                t.newDateFixed(this.picker, B)) && aa.isBefore(t.newDateFixed(this.picker, E));
            var H = M.isAfter(t.newDateFixed(this.picker, B)) && M.isAfter(t.newDateFixed(this.picker, E)) && aa.isAfter(t.newDateFixed(
                this.picker, B)) && aa.isAfter(t.newDateFixed(this.picker, E));
            if (H || ab) {
                return
            }
            if (Y) {
            ...
            if (W.is(R)) {
                ...
                if (C.length === 2) {
                    var N = W.parents("tr");
                    var V = R.parents("tr");
                    if (W.parents(".c-datepicker-date-range-picker-panel__wrap").is(R.parents(
    ...
    g.extend(q.prototype, {
        ...
        initShow: function () {
            ...
            var D = g(C.replace(/{{table}}/g, I).replace(/{{year}}/g, G.year).replace(/{{month}}/g, G.month).replace(
                "{{sidebar}}", o).replace("{{hasTime}}", H).replace("{{hasSidebar}}", F));
            g("body").append(D);
            this.$container = D;
    ...
    Date.prototype.format = function () {
        var s1 = '';
        s1 += this.getFullYear() + '-'; // 获取年份。
        if ((this.getMonth() + 1) < 10) {
            s1 += "0" + (this.getMonth() + 1) + "-";
        } else {
            s1 += (this.getMonth() + 1) + "-"; // 获取月份。
        }
        if (this.getDate() < 10) {
            s1 += "0" + this.getDate(); // 获取日。
        } else {
            s1 += this.getDate(); // 获取日。
        }
        return (s1); // 返回日期。
    ...
    function datas() {
        ...
        for (var k = unixDb; k <= unixDe;) {
            sdate += (new Date(parseInt(k))).format() + ',';
            k = k + 24 * 60 * 60 * 1000;
        }
        // console.log(sdate)
        var s = sdate.split(",").slice(0, -1);
        //	 console.log(s)
        var s2 = s.toString();
        console.log(s2)
        $.ajax({
            url: 'http://api.wappt.cn/customer/number.php',
            async: false,
            type: 'POST',
            data: {
                date: s2
